...
export default function UserForm2() {
  ...
  const [menuItemArray, SetmenuItemArray] = useState(["LinkedIn", "GitHub"]);
          ...
          {menuItemArray.map((type, i) => (
            <MenuItem
              ...
              onClick={(e) => {
                ...
                menuItemArray.splice(
                  menuItemArray.indexOf(e.currentTarget.value),
                  1
                );
                // We then add it to the shareable array that we want inputs for
                SetinputArray([...inputArray, e.currentTarget.value]);
              }}
            >
              <Icon
